...
class AnteproyectoController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $registro=anteproyecto::create(['Nombre_anteproyecto'=>$request['Nombre_anteproyecto'],'Tipo_Anteproyecto'=>$request['Tipo_Anteproyecto'],'Nombre_estudiante1'=>$request['Nombre_estudiante1'], 'Cedula_est1'=>$request['Cedula_est1'],'Nombre_estudiante2'=>$request['Nombre_estudiante2'],'Cedula_est2'=>$request['Cedula_est2'],'Asesor'=>$request['Asesor'], 'Asesor_empresa'=>$request['Asesor_empresa'], 'Nombre_empresa'=>$request['Nombre_empresa'],'Carrera'=>$request['carrera'], 'Estado'=>$request['Estado']]);
